...
function getSessionFlow(unit: PracticeUnit) {
...
function getDraftSummary(status: UnitDraftStatus | undefined) {
  if (!status) {
    return {
      label: '未开始',
...
function recommendationCopy(reason: PracticeRecommendationReason) {
